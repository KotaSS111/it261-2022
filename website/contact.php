...
<main>
<h1>Welocme to our contact page!</h1>

<p>This is the page for students to solve any problem. Please fill out below. Glad to help you!</p>
...
<head>
    ...
    <link href="weeks/week7/css/styles.css" type="text/css" rel="stylesheet">
</head>
<body>
...
<label>Your Mejour</label>
<ul>
    <!-- we will return to the wine portion to add additional wines when we are adding the sticky part of our form -->
<li>
<input type="checkbox" name="major[]" value="pycology" <?php if(isset($_POST['major']) && in_array('pycology', $mejour)) echo 'checked ="checked"' ;?>>Pycology
</li>

<li>
<input type="checkbox" name="major[]" value="math" <?php if(isset($_POST['major']) && in_array('math', $mejour)) echo 'checked ="checked"'  ;?>>Math
</li>

<li>
<input type="checkbox" name="major[]" value="IT" <?php if(isset($_POST['major']) && in_array('IT', $mejour)) echo 'checked ="checked"'  ;?>>IT
</li>

<li>
<input type="checkbox" name="major[]" value="engineering" <?php if(isset($_POST['major']) && in_array('engineering', $mejour)) echo 'checked ="checked"'  ;?>>Engineering
</li>

<li>
<input type="checkbox" name="major[]" value="art" <?php if(isset($_POST['major']) && in_array('art', $mejour)) echo 'checked ="checked"'  ;?>>Art
</li>

</ul>
<span class="error"><?php echo $mejour_err     ;?></span>
...
<option value="HW" <?php if(isset($_POST['about']) && $_POST['about'] == 'nw') echo 'selected = "selected" '  ;?>>Homework</option>

<option value="Tutoring" <?php if(isset($_POST['about']) && $_POST['about'] == 'sw') echo 'selected = "selected" '  ;?>>Tutoring</option>

<option value="Teacher" <?php if(isset($_POST['about']) && $_POST['about'] == 'mw') echo 'selected = "selected" '  ;?>>Teacher</option>

<option value="Event" <?php if(isset($_POST['about']) && $_POST['about'] == 'ec') echo 'selected = "selected" '  ;?>>Event</option>

<option value="Other" <?php if(isset($_POST['about']) && $_POST['about'] == 'ne') echo 'selected = "selected" '  ;?>>Other</option>
